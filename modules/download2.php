...
if(isset($_POST["download"])){
    ...
    $chart_heading3 = secure_parameter($_POST["chart_heading3"]);
    $file_name = $chart_heading1.'_'.$chart_heading2.'_'.$chart_heading3;
//    echo $file_name;
//    die();
    $column1 = secure_parameter($_POST["column_name1"]);
    $column2 = secure_parameter($_POST["column_name2"]);
    $column3 = secure_parameter($_POST["column_name3"]);
    require 'db.php';
    $output = "";
