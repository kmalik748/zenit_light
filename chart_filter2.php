    ...
    <body>
        ...
        <div class="graph_plot pl-4 pr-4 mt-5">
            <div class="container mb-4 timing_headings d-flex">
                ...
                <form class="ml-auto" action="modules/download2.php" method="post">
                    ...
                    <input type="hidden" name="chart_heading3" value="<?php echo $chart_heading3; ?>">
                    ...
                    <input type="hidden" name="column_name3" value="<?php echo $column_name3; ?>">
